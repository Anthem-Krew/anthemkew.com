# Code of Conduct for the `anthemkrew.com` project

([Français](#Code-de-conduite-pour-le-projet-anthemkrew.com))

Contributors to repositories hosted in [`Anthem-Krew`](https://github.com/Anthem-Krew/) are expected to follow the Contributor Covenant Code of Conduct.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at [`info@anthemkrew.com`].
...
# Code de conduite pour le projet `Gabarit Jekyll de Canada.ca`

([English](#Code-of-Conduct-for-the-anthemkrew.com-project))

Les contributeurs aux dépôts hébergés dans [`Anthem-Krew`](https://github.com/Anthem-Krew/) sont tenus de respecter le Code de conduite du Pacte des contributeurs.
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante :[`info@anthemkrew.com`].
